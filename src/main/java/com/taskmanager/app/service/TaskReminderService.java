...
public class TaskReminderService {
    ...
    private String buildEmailMessage(Task task) {
        ...
        return "<html>"
                ...
                + "<p>Hãy trở về trang chủ để gia hạn thêm thời gian, nhấn nút  về trang chủ:</p>"
                + "<div class='button-container'>"
                + "<a href='https://task-management-system-fe-xqh9.vercel.app/' class='button'>Vào trang chủ</a>"
                + "</div>"
